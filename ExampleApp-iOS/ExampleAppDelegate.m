...
//	[self.vc.view insertSubview:messageButton aboveSubview:webView];
    [self.vc.view addSubview:messageButton];
	messageButton.frame = CGRectMake(20, 414, 130, 45);
    
    UIButton *callbackButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [callbackButton setTitle:@"Call handler" forState:UIControlStateNormal];
    [callbackButton addTarget:self action:@selector(callHandler:) forControlEvents:UIControlEventTouchUpInside];
//    [self.vc.view insertSubview:callbackButton aboveSubview:webView];
    [self.vc.view addSubview:callbackButton];
